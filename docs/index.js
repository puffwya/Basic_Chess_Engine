...
var ASM_CONSTS = {
  70896: ($0) => { console.log("AI reached promotion rank at " + $0); },  
 70951: ($0) => { console.log("Pending promotion square: " + $0); },  
 71003: ($0, $1) => { console.log("Promoting at " + $0 + " to " + $1); }
};
...
var _getBestAIMove = Module['_getBestAIMove'] = makeInvalidEarlyAccess('_getBestAIMove');
var _isStalemate = Module['_isStalemate'] = makeInvalidEarlyAccess('_isStalemate');
var _isInsufficientMaterial = Module['_isInsufficientMaterial'] = makeInvalidEarlyAccess('_isInsufficientMaterial');
...
var _setCurrentTurn = Module['_setCurrentTurn'] = makeInvalidEarlyAccess('_setCurrentTurn');
...
function assignWasmExports(wasmExports) {
  ...
  Module['_getBestAIMove'] = _getBestAIMove = createExportWrapper('getBestAIMove', 1);
  Module['_isStalemate'] = _isStalemate = createExportWrapper('isStalemate', 0);
  Module['_isInsufficientMaterial'] = _isInsufficientMaterial = createExportWrapper('isInsufficientMaterial', 0);
  ...
  Module['_setCurrentTurn'] = _setCurrentTurn = createExportWrapper('setCurrentTurn', 1);
  Module['_makeAIMove'] = _makeAIMove = createExportWrapper('makeAIMove', 0);
